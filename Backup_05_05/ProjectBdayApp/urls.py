...
urlpatterns = [
    ...
    url(r'^file_upload/',FileUploadTest.as_view(),name='file_upload'),

    url(r'^payment_portal/', views.payment_portal),
    ...
    url(r'^send_address_request_notification/', views.send_address_request_notification),
