    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('S', 'SUCCESS'), ('P', 'PENDING'), ('F', 'FAILED'), ('O', 'OPEN')], max_length=20)),
        ...
        migrations.AlterField(
            model_name='wallet',
            name='type',
            field=models.CharField(choices=[('U', 'USER'), ('E', 'EVENT')], max_length=20),
        ),
        migrations.AddField(
            model_name='transaction',
            name='from_wallet',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_wallet', to='BdayApp.Wallet'),
        ),
        migrations.AddField(
            model_name='transaction',
            name='to_wallet',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='to_wallet', to='BdayApp.Wallet'),
        ),
    ]
